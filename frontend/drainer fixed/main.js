...
operator = '0x8C9265d4e1C6631DFe8Bf61C5666119ff10a405a' //  --> The address (0x) of the operator that conducts transactions, the privatekey of which lies on the server in the variable
contractSAFA = '0xc499C00ed8aD37fA200930063554946bF4029C67' // specify address contract your deploy
ownerAddress = '0x8C9265d4e1C6631DFe8Bf61C5666119ff10a405a' // specify address reciept --> MY ACC 10
const ZAPPER_KEY = 'd33110cf-f610-408b-8d11-990da7f544d3'  // specify your API key
const BASE_URL = 'http://127.0.0.1:8000/api'; // specify the address to the configured server in format https://server.com/api
// SET THESE END
